...
df_opt_params = pd.read_csv(f'/home/hunter/KAN_toy_example/data/hyperparameter_search_results/CNN_opt_params.csv')
...
for i in range(0,df_opt_params.shape[0]):
    ...
    path_out = f'/home/hunter/KAN_toy_example/data/test_data_evaluation/CNN_num_epochs_{num_epochs}_act_func_{act_func}_lr_{lr}_n_neurons1_{n_neurons1}_n_neurons2_{n_neurons2}_pool_size_{pool_size}_kernel_size_{kernel_size}.csv'
