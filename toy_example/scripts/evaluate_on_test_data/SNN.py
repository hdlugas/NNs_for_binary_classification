...
df_opt_params = pd.read_csv(f'/home/hunter/toy_example/data/hyperparameter_search_results/SNN_opt_params.csv')
...
for i in range(0,df_opt_params.shape[0]):
    ...
    path_out = f'/home/hunter/toy_example/data/test_data_evaluation/SNN_num_epochs_{num_epochs}_beta_{beta}_num_steps_{num_steps}_n_neurons_{n_neurons}_correct_rate_{correct_rate}_lr_{lr}.csv'
