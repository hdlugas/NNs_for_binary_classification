...
df_opt_params = pd.read_csv(f'/home/hunter/KAN_toy_example/data/hyperparameter_search_results/BNN_opt_params.csv')
...
for i in range(0,df_opt_params.shape[0]):
    ...
    path_out = f'/home/hunter/KAN_toy_example/data/test_data_evaluation/BNN_num_epochs_{num_epochs}_lr_{lr}_n_neurons_{n_neurons}_act_func_{act_func}_kl_weight_{kl_weight}.csv'
