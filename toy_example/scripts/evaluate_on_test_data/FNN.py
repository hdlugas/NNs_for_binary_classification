...
df_opt_params = pd.read_csv(f'/home/hunter/toy_example/data/hyperparameter_search_results/FNN_opt_params.csv')
...
for i in range(0,df_opt_params.shape[0]):
    ...
    path_out = f'/home/hunter/toy_example/data/test_data_evaluation/FNN_num_epochs_{num_epochs}_act_func_{act_func}_lr_{lr}_n_neurons_{n_neurons}.csv'
