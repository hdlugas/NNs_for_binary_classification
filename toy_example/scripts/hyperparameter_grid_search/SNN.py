            ...
            for n_neurons in n_neurons_range:
                for correct_rate in correct_rate_range:
                    for lr in lr_range:
                        ...
                        path_out = f'/home/hunter/toy_example/data/hyperparameter_search_results/SNN_num_epochs_{num_epochs}_beta_{beta}_num_steps_{num_steps}_n_neurons_{n_neurons}_correct_rate_{correct_rate}_lr_{lr}.csv'
