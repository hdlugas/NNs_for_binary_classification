...
path = '/home/hunter/toy_example/data/hyperparameter_search_results/'
...
write.csv(df.bnn.opt.params, paste0('/home/hunter/toy_example/data/hyperparameter_search_results/BNN_opt_params.csv'), row.names=F)
write.csv(df.cnn.opt.params, paste0('/home/hunter/toy_example/data/hyperparameter_search_results/CNN_opt_params.csv'), row.names=F)
write.csv(df.fnn.opt.params, paste0('/home/hunter/toy_example/data/hyperparameter_search_results/FNN_opt_params.csv'), row.names=F)
write.csv(df.kan.opt.params, paste0('/home/hunter/toy_example/data/hyperparameter_search_results/KAN_opt_params.csv'), row.names=F)
write.csv(df.snn.opt.params, paste0('/home/hunter/toy_example/data/hyperparameter_search_results/SNN_opt_params.csv'), row.names=F)
