                    ...
                    for dropout_rate in dropout_rate_range:
                        for kernel_size in kernel_size_range:
                            for act_func in act_funcs:
                                ...
                                path_out = f'/home/hunter/toy_example/data/hyperparameter_search_results/CNN_num_epochs_{num_epochs}_act_func_{act_func}_lr_{lr}_n_neurons1_{n_neurons1}_n_neurons2_{n_neurons2}_pool_size_{pool_size}_dropout_rate_{dropout_rate}_kernel_size_{kernel_size}.csv'
