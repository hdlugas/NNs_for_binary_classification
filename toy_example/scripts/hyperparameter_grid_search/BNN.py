        ...
        for n_neurons in n_neurons_range:
            for kl_weight in kl_weight_range:
                for act_func in act_funcs:
                    ...
                    path_out = f'/home/hunter/toy_example/data/hyperparameter_search_results/BNN_num_epochs_{num_epochs}_lr_{lr}_n_neurons_{n_neurons}_act_func_{act_func}_kl_weight_{kl_weight}.csv'
