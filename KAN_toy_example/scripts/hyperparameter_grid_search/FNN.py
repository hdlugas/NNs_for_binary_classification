    ...
    for lr in lr_range:
        for n_neurons in n_neurons_range:
            for act_func in act_funcs:
                ...
                path_out = f'/home/hunter/KAN_toy_example/data/hyperparameter_search_results/FNN_num_epochs_{num_epochs}_act_func_{act_func}_lr_{lr}_n_neurons_{n_neurons}.csv'
