...
df_opt_params = pd.read_csv(f'/home/hunter/KAN_toy_example/data/hyperparameter_search_results/KAN_opt_params.csv')
...
for i in range(0,df_opt_params.shape[0]):
    ...
    path_out = f'/home/hunter/KAN_toy_example/data/test_data_evaluation/KAN_num_epochs_{num_epochs}_grid_{grid}_k_{k}_n_neurons_{n_neurons}.csv'
